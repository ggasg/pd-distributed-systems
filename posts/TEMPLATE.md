...
[Name a real system (Kafka, Flink, Postgres, DynamoDB, etc.) and explain concretely how what you built appears in it. "This is basically how Kafka's log compaction works" or "FlashAttention solves the same memory bandwidth problem I hit in W14."]
...
*This is week X of a [20]-week engineering curriculum on distributed systems. [Link to repo]*
