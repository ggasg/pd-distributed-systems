...
[One concrete follow-on. Not vague like "explore further" — specific like "implement the all-gather phase of ring-allreduce over UDP to see if the extra complexity is worth it."]
