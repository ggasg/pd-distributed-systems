...
│   ├── explain_join.py              # optional stretch: PySpark, watch a real planner pick a strategy
│   └── build.sbt
│
...
│   └── pom.xml
│
├── spark-k8s-job/          # W14 Part 2b: Scala (sbt), submitted to the Spark Operator
...
```
No `go build` specific to W14/W16 themselves: those two weeks deploy CRs against operators you installed, not code you compiled. Go is very much built everywhere else in this curriculum, W00–W03, W06, and every secondary tool.
