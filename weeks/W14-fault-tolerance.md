...
- [ ] `Coordinator.java`: wires 3 nodes in a ring (0 to 1 to 2 to 0), starts virtual thread per node, injects a sequence of data messages, then triggers snapshot from node 0, waits for all nodes to report their recorded states
